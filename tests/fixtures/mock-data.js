...
export const mockInstruments = [
  {
    id: 1,
    platform_id: 2,  // Changed from 1 to 2 so platform 1 has no instruments for DELETE test
    normalized_name: 'SVB_MIR_PL02_PHE01',
    display_name: 'SVB Mire Phenocam 01',
  ...
  },
  {
    id: 2,
    platform_id: 2,
    normalized_name: 'SVB_MIR_PL02_MS01',
    display_name: 'SVB Mire Multispectral 01',
  ...
  {
    id: 3,
    platform_id: 4,  // Changed from 2 to 4 (ANS platform)
    normalized_name: 'ANS_ALP_PL01_PAR01',
    display_name: 'ANS Alpine PAR Sensor 01',
    instrument_type: 'par',
    status: 'active',
    latitude: 68.354,
    longitude: 18.816,
