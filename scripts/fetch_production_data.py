#!/usr/bin/env python3
"""
Fetch production data from Cloudflare D1 database and generate updated stations.yaml

This script:
1. Queries the Cloudflare D1 production database using wrangler
...
Usage:
    python fetch_production_data.py

Requirements:
    - wrangler CLI installed and authenticated
    - Access to the spectral_stations_db database
"""
...
class CloudflareD1Fetcher:
    """Fetch data from Cloudflare D1 database"""

    def __init__(self, database_name: str):
        self.database_name = database_name
        self.wrangler_path = "wrangler"

    def execute_query(self, query: str) -> List[Dict]:
        """Execute SQL query using wrangler d1 execute"""
        try:
            cmd = [
                self.wrangler_path,
                "d1",
...
class YAMLGenerator:
    ...
    def __init__(self, fetcher: CloudflareD1Fetcher):
...
def main():
    """Main execution"""
    print("="*80)
    print("SITES Spectral - Production Data Fetch from Cloudflare D1")
    print("="*80)
    print()

    # Initialize fetcher
    fetcher = CloudflareD1Fetcher(DATABASE_NAME)

    # Initialize generator
    generator = YAMLGenerator(fetcher)

    # Generate YAML structure
    print("Fetching data from Cloudflare D1 database...")
