...
class AOIModal {
    ...
    /**
     * Add CSS styles for modal by loading external stylesheet
     * Styles are now in /css/aoi-modal.css for separation of concerns
     */
    addStyles() {
        if (document.getElementById('aoi-modal-styles')) return;

        const link = document.createElement('link');
        link.id = 'aoi-modal-styles';
        link.rel = 'stylesheet';
        link.href = '/css/aoi-modal.css?v=13.17.0';
