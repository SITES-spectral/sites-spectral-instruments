  ...
  async getStationExportData(identifier) {
    const result = await this.db.prepare(`
      SELECT
        ...
        p.mount_type_code as platform_location_code,
        ...
        i.camera_fov as instrument_camera_fov,
        i.camera_mount_height as instrument_height,
        i.camera_orientation as instrument_camera_orientation,
        i.measurement_status as instrument_measurement_status,
        i.description as instrument_description,
        i.specifications as instrument_specifications,
