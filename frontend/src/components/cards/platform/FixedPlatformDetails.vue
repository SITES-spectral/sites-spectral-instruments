 ...
 * Shows: ecosystem, mount type (PL/BL/GL), height, mounting structure, mini-map
 *
...
import PlatformMiniMap from '@components/maps/PlatformMiniMap.vue';
...
// Check if platform has coordinates for mini-map
...
<template>
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm">
      ...
      <!-- Coordinates (text display below map) -->
      <div v-if="hasCoordinates" class="col-span-2 sm:col-span-3">
        <span class="text-xs text-base-content/50 block">Coordinates</span>
